    ...
    *pframeindex = (byte *)paliasgroup - (byte *)pheader;
    ...
    for ( i = 0; i < numframes; i++ ) {
        ptemp = Mod_LoadAliasFrame( ptemp, &paliasgroup->frames[i].frame, numv,
                                    ...
                                    &paliasgroup->frames[i].bboxmax, pheader,
                                    name );
    }
...
void *Mod_LoadAliasSkin( void *pin, int *pskinindex, int skinsize,
    ...
    *pskinindex = (byte *)pskin - (byte *)pheader;
    ...
    if ( r_pixbytes == 1 ) {
        ...
        for ( i = 0; i < skinsize; i++ ) pusskin[i] = d_8to16table[pinskin[i]];
    } else {
...
void Mod_LoadAliasModel( model_t *mod, void *buffer ) {
    ...
    pskindesc =
        Hunk_AllocName( numskins * sizeof( maliasskindesc_t ), loadname );
...
void *Mod_LoadSpriteFrame( void *pin, mspriteframe_t **ppframe ) {
    ...
    *ppframe = pspriteframe;
    ...
    if ( r_pixbytes == 1 ) {
        ...
        for ( i = 0; i < size; i++ ) ppixout[i] = d_8to16table[ppixin[i]];
    } else {
