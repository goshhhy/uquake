...
#include "../quakedef.h"
#include "r_local.h"
#include "../draw/d_local.h"  // FIXME: shouldn't need to include this
...
void R_RenderPoly( msurface_t *fa, int clipflags ) {
    ...
    while ( pclip ) {
        ...
        lastdist =
            DotProduct( verts[vertpage][lastvert].position, pclip->normal ) -
            pclip->dist;
    ...
    // build the polygon descriptor, including fa, r_nearzi, and u, v, s, t, and
    // z for each vertex
