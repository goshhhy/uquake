...
void VID_Init8bitPalette( void ) {
    ...
    if ( strstr( gl_extensions, "3DFX_set_global_palette" ) &&
         ( qgl3DfxSetPaletteEXT = dlsym( prjobj, "gl3DfxSetPaletteEXT" ) ) !=
             NULL ) {
        GLubyte table[256][4];
        char *oldpal;
        ...
        is8bit = true;
                ...
                ( qglColorTableEXT = dlsym( prjobj, "glColorTableEXT" ) ) !=
                    NULL ) {
...
void VID_Init( unsigned char *palette ) {
    ...
    if ( !visinfo ) {
        fprintf( stderr,
                 "qkHack: Error couldn't get an RGB, Double-buffered, Depth "
                 "visual\n" );
        exit( 1 );
    }
